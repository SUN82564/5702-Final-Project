...
# Chapter 5 Factors which effects labor force and employment
...
## 1 Developed and Developing country

First we need to make a definition of a developed country and developing country. A developed country is a country has advanced technological infrastructure and high standard of living comparing to other less developed country and those less developed countries are called developing countries. However, there is no specific standard for classifying developed country. In our project, we define a country with GDP per capita over than 12,000 dollar is a developed country and less than 12,000 dollar is a developing country.
...
spine_data <- cleaned_data %>% rename(
  ...
  select(Country.Name, Series.Name, '2016')
...
## 3 Developed and Developing country

A developed country is a country has advanced technological infrastructure and high standard of living comparing to other less developed country and those less developed countries are called developing countries. However, there is no specific standard for classifying developed country. In our project, we define a country with GDP per capita over than 12,000 dollar is a developed country and less than 12,000 dollar is a developing country.
...
The graph provides an overview of employment rate in most countries around the world. From the graph we could see that most developed country and major economies has a high level of employment rate. The areas of low employment rate are concentrated on middle Asia and north Africa. These countries has various reasons such as war, imbalances in economic structures, and the inequality of male and female. Countries located in South America and Southeast Asia maintain a middle employment rate around seventy percent. We will then
...
```
We could see four cluster in above contour plot. One concentrated cluster is around (0.7,99), which indicates most countries with a high literacy rate has acceptable employment rate. The contour line shows that the employment rate increases with the rate of literacy. However, there exist a few outliers that they have a distinctly lower literacy rate with high employment rate and high literacy rate with low employment rate. The plot also indicates that no country has high extremely employment rate with low literacy rate. According to above results, we could imply that there exist a positive association between literacy rate and employment rate.

## Employment rate among different eduaction level

We then compare how level of knowledge affect employment in developing and developed countries. According to the graph of world employment rate. We pick Brazil, Egypt, South Africa, USA and UK to do this comparison. Among these countries, Brazil, Egypt and South Africa are developing countries, while UK and USA are developed countries. The reason that we are not using China and Japan as our previous parts is that China and Japan are missing data both from year and education level. We will classify education into three levels, which is basic, intermediate and advanced. Basic level is defined as schooling leads to basic reading, writing and mathematics skills. Intermediate level education refers to  Advance level education means all levels of colleges or universities and higher institutes.
...
ggplot(df_ed, aes(fill=Series, y=Rate, x=Country))+
  ...
  theme(panel.border =  element_blank(),
        plot.title = element_text(hjust = 0.5))
```
According to this graph, all five countries, whether it is a developed country or not, reflect a similar trend that people with higher level of education are more easier to be employed. All five countries has about 80 percent of employment rate with people who have an advanced education. Brazil has a higher employment rate in basic education and similar employment rate with intermediate and advanced education in 2012. However, as time past, the employment rate distribution of Brazil has changed to a similar ratio as other countries. 
